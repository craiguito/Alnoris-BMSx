...
def build_test_catalog() -> tuple[VirtualTestDefinition, ...]:
    return (
        ...
        VirtualTestDefinition(
            ...
            display_name="Model Validation Test",
            description="Replay a truth-set current trace and compare simulated voltage, energy, and temperature metrics.",
            category="Calibration / Validation",
            difficulty="advanced",
            recommended_for_pack_level=True,
