...
PRIMARY_TEST_CATALOG: tuple[VirtualTestDefinition, ...] = (
    ...
    VirtualTestDefinition(
        ...
        parameters=(
            ...
            _param("max_high_soc_voltage_rmse_v", "Max high-SOC voltage RMSE", "float", 1.0, min_value=0.0, unit="V"),
            _param("max_mid_soc_voltage_rmse_v", "Max mid-SOC voltage RMSE", "float", 1.0, min_value=0.0, unit="V"),
            _param("max_low_soc_voltage_rmse_v", "Max low-SOC voltage RMSE", "float", 1.0, min_value=0.0, unit="V"),
            _param(
                "max_last_10_percent_voltage_rmse_v",
                "Max last-10% voltage RMSE",
                "float",
                1.0,
                min_value=0.0,
                unit="V",
            ...
            _param(
                ...
                "Max cutoff-neighborhood voltage RMSE",
                "float",
                1.0,
                min_value=0.0,
                unit="V",
