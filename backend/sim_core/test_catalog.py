...
def build_test_catalog() -> tuple[VirtualTestDefinition, ...]:
    return (
        VirtualTestDefinition(
            ...
            parameters=(
                ...
                _param("ambient_temp_c", "Ambient temperature", "float", 25.0, min_value=-40.0, max_value=120.0, unit="C"),
                _param("time_step_s", "Time step", "float", 1.0, min_value=0.1, unit="s"),
        ...
        VirtualTestDefinition(
            ...
            parameters=(
                ...
                _param("ambient_temp_c", "Ambient temperature", "float", 25.0, min_value=-40.0, max_value=120.0, unit="C"),
                _param("time_step_s", "Time step", "float", 1.0, min_value=0.05, unit="s"),
            ),
        ),
        VirtualTestDefinition(
        ...
        VirtualTestDefinition(
            ...
            display_name="Rate Capability Test",
            description="Compare capacity and energy delivered across multiple discharge currents.",
            category="Comparative Analysis",
            difficulty="intermediate",
            recommended_for_pack_level=True,
            parameters=(
                _param("current_list_a", "Currents", "list_float", [2.0, 5.0, 8.0], unit="A", tooltip="Comma-separated list is accepted by the desktop UI."),
                _param("initial_soc", "Initial SOC", "float", 1.0, min_value=0.0, max_value=1.0),
                _param("ambient_temp_c", "Ambient temperature", "float", 25.0, min_value=-40.0, max_value=120.0, unit="C"),
                _param("time_step_s", "Time step", "float", 1.0, min_value=0.1, unit="s"),
                _param("max_duration_s", "Max duration", "float", 3600.0, min_value=1.0, unit="s"),
        ...
        VirtualTestDefinition(
            ...
            display_name="Thermal Stress Test",
            description="Run a sustained load to compare heating behavior and hottest-group response.",
            category="Storage / Aging",
            difficulty="basic",
            recommended_for_pack_level=True,
            ...
            parameters=(
                ...
                _param("ambient_temp_c", "Ambient temperature", "float", 35.0, min_value=-40.0, max_value=120.0, unit="C"),
                _param("time_step_s", "Time step", "float", 1.0, min_value=0.1, unit="s"),
            ),
        ),
        VirtualTestDefinition(
            ...
            parameters=(
                ...
                _param("initial_soc", "Initial SOC", "float", 0.8, min_value=0.0, max_value=1.0),
                _param("ambient_temp_c", "Ambient temperature", "float", 35.0, min_value=-40.0, max_value=120.0, unit="C"),
                _param("self_discharge_per_day", "Self-discharge", "float", 0.0005, min_value=0.0, max_value=0.05, unit="fraction/day"),
                _param("time_step_s", "Time step", "float", 3600.0, min_value=1.0, unit="s"),
            ),
        ),
        VirtualTestDefinition(
            ...
            parameters=(
                ...
                _param("ambient_temp_c", "Ambient temperature", "float", 25.0, min_value=-40.0, max_value=120.0, unit="C"),
                _param("fault_specs", "Fault specs", "json", [{"fault_type": "high_resistance_group", "group_index": 0, "factor": 2.0}], tooltip="JSON list of fault specs."),
            ),
        ),
        VirtualTestDefinition(
        ...
        VirtualTestDefinition(
            ...
            display_name="Thermal Zone Comparison Test",
            description="Compare pack response across thermally distinct group zones.",
            category="Comparative Analysis",
            difficulty="advanced",
            recommended_for_pack_level=True,
            supports_thermal_zones=True,
            parameters=(
                ...
                _param("initial_soc", "Initial SOC", "float", 0.9, min_value=0.0, max_value=1.0),
                _param("ambient_temp_c", "Ambient temperature", "float", 25.0, min_value=-40.0, max_value=120.0, unit="C"),
                _param("zone_cooling_multipliers", "Zone cooling multipliers", "list_float", [0.8, 1.2], tooltip="Used if the base config has no explicit thermal zones."),
            ),
        ),
    )
